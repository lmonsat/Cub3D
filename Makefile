...
# SRC and OBJ files
SRC = main.c parsing.c utils.c raycasting.c gameplay.c get_next_line.c get_next_line_utils.c mlx_functions.c mapping.c  requested_player_move.c player_move.c draw_lines.c draw_lines1.c init_line.c vertical_band.c game_loop.c
